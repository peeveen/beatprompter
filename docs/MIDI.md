...
| Active outgoing MIDI channels              | This allows you to specify what MIDI channels BeatPrompter will send data to. Messages intended for unselected channels will not be sent.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| Send initial MIDI messages at title screen | If set, any initial MIDI messages that a song contains (i.e. those declared before the first line) will be sent at the title screen. Otherwise, they will be sent when the song is first displayed (after the title screen).                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
