        ...
        override fun handleMessage(msg: Message) {
            if (mSongDisplayActive)
                when (msg.what) {
                    ...
                    Events.BLUETOOTH_SET_SONG_TIME -> mSongView?.setSongTime(msg.obj as Long, redraw = true, broadcast = false, setPixelPosition = true, recalculateManualPositions = true)
