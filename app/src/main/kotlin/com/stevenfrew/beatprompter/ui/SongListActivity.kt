...
class SongListActivity
	...
	private fun performCloudSync(fileToUpdate: CachedFile?, dependenciesToo: Boolean) {
		...
		if (cloudPath.isNullOrBlank())
			Toast.makeText(this, getString(R.string.no_cloud_folder_currently_set), Toast.LENGTH_LONG)
				.show()
		else {
	...
	class SongListEventHandler internal constructor(private val mSongList: SongListActivity) :
		Handler() {
