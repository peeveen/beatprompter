...
abstract class Line internal constructor(val mLineTime:Long, val mLineDuration:Long, val mBeatInfo:BeatInfo, val mSongPixelPosition:Int, val mYStartScrollTime:Long, val mYStopScrollTime:Long) {
