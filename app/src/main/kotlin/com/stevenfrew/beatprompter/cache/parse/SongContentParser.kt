...
abstract class SongContentParser<TResultType>(
	...
	override fun parseLine(line: TextFileLine<TResultType>): Boolean {
		...
		val variationInclusionEndTag =
			tagSequence.filterIsInstance<EndOfVariationInclusionTag>().firstOrNull()
		if (variationExclusionEndTag != null || variationInclusionEndTag != null)
