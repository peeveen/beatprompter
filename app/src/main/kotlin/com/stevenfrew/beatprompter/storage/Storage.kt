...
abstract class Storage protected constructor(protected var mParentActivity: Activity, cloudCacheFolderName: String) {
    ...
    init {
        ...
        if (!cacheFolder.exists())
            if (!cacheFolder.mkdir())
                Log.e(BeatPrompterApplication.TAG, "Failed to create storage cache folder.")
    }
    ...
    protected abstract fun getRootPath(listener: StorageListener, rootPathSource: PublishSubject<FolderInfo>)
