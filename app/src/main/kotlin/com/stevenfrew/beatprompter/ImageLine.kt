...
class ImageLine internal constructor(mImageFile:ImageFile, scalingMode:ImageScalingMode,lineTime:Long,lineDuration:Long,scrollMode:ScrollingMode,displaySettings:SongDisplaySettings,pixelPosition:Int,startScrollTime:Long,stopScrollTime:Long) : Line(lineTime,lineDuration,scrollMode,pixelPosition,startScrollTime,stopScrollTime) {
    ...
    init
    {
        mMeasurements=LineMeasurements(1, mDestinationRect.width(), mDestinationRect.height(), intArrayOf(mDestinationRect.height()), lineTime,lineDuration, startScrollTime, scrollMode,displaySettings.mScreenSize)
    }
