...
class CloudDownloadTask extends AsyncTask<String, String, Boolean>
{
    ...
    CloudDownloadTask(CloudStorage cloudStorage,Handler handler, String cloudPath, boolean includeSubFolders,ArrayList<CachedCloudFile> filesToUpdate)
    {
