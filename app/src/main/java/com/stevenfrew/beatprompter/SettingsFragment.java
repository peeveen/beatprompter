...
public class SettingsFragment extends PreferenceFragment implements GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener
{
    ...
    boolean mAuthorizingDropbox=false;
    ...
    final static private String DROPBOX_APP_KEY = "hay1puzmg41f02r";

    SharedPreferences.OnSharedPreferenceChangeListener mCloudPathPrefListener = new
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(cloudPathPref!=null) {
            cloudPathPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
