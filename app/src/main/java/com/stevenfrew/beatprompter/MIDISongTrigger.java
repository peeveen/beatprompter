...
class MIDISongTrigger
{
    ...
    static MIDISongTrigger DEAD_TRIGGER=new MIDISongTrigger(new MIDIValue(NEVER_VALUE),new MIDIValue(NEVER_VALUE),new MIDIValue(NEVER_VALUE),true,new MIDIValue(NEVER_VALUE,true));

    MIDISongTrigger(byte bankSelectMSB,byte bankSelectLSB,byte triggerIndex,boolean songSelect,byte channel)
    {
    ...
    void writeToXML(Document doc, Element parent,String tag)
    {
    ...
    static MIDISongTrigger readFromXMLElement(Element element)
    {
    ...
    ArrayList<MIDIOutgoingMessage> getMIDIMessages(byte defaultOutputChannel)
    {
