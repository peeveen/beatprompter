...
public class BaseEvent {
    BaseEvent mPrevEvent;
    BaseEvent mNextEvent;
    ColorEvent mPrevColorEvent;
    TrackEvent mPrevTrackEvent;
    //ScrollEvent mPrevScrollEvent;
    BeatEvent mPrevBeatEvent;
    LineEvent mPrevLineEvent;

    long mEventTime; // Time at which this event occurs (in nanoseconds AFTER the globalStart time)
    ...
    void insertAfter(BaseEvent event)
    {
    ...
    void offsetLaterEvents(long amount)
    {
    ...
    BaseEvent findEventOnOrBefore(long time)
    {
