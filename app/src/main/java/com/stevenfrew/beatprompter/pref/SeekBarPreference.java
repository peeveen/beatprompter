...
public class SeekBarPreference extends DialogPreference implements SeekBar.OnSeekBarChangeListener, OnClickListener
{
    ...
    private int mDefault, mMax, mValue,mOffset=0;
    // ------------------------------------------------------------------------------------------
    ...
    public SeekBarPreference(Context context, AttributeSet attrs) {
        ...
        mMax = getAttributeIntValue(attrs, androidns, "max", 100);
        mOffset = getAttributeIntValue(attrs, sfns, "offset",0);
    }
    // ------------------------------------------------------------------------------------------


    private int getAttributeIntValue(AttributeSet attrs,String namespace,String name,int lastResortDefault)
    {
        int resourceID=attrs.getAttributeResourceValue(namespace,name,0);
        if(resourceID==0)
            return attrs.getAttributeIntValue(namespace, name, lastResortDefault);
        return Integer.parseInt(getContext().getString(resourceID));
    ...
    {
        String t = String.valueOf(value+mOffset);
