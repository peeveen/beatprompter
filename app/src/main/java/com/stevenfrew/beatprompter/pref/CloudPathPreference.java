...
public class CloudPathPreference extends Preference
{
    ...
    public void onBindView(View view) {
        ...
        SharedPreferences prefs=BeatPrompterApplication.getPreferences();
        String path=prefs.getString(BeatPrompterApplication.getResourceString(R.string.pref_cloudPath_key),null);
        String displayPath=prefs.getString(BeatPrompterApplication.getResourceString(R.string.pref_cloudDisplayPath_key),null);
        if(path==null)
